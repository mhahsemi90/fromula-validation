...
import {getOperatorFromMainList} from "../../IntermediateFrame/getElementFromMainList.js";
...
const addBinaryExpressionToBlocks = (blocks, expression) => {
    ...
    for (expression of expressionList) {
        if (expression.type === ExpressionType.BINARY_EXPRESSION) {
            ...
            let result = [
                ...firstExpression,
                new Block(BlockType.BINARY_OPERATOR,operator.title,operator.code,operator.code),
                ...secondExpression
            ];
